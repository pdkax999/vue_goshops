  ...
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShopModal=true">
      <img :src="info.avatar">
    ...
    <div class="shop-header-discounts" @click="isDiscountsShow=true" v-if="info.supports">
    ...
    <div class="shop-brief-modal" v-if="isShopModal">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer"  @click="isShopModal=false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="brief-modal-cover" @click="isShopModal=false"></div>
    </div>
    </transition>
    <div class="activity-sheet" v-if="isDiscountsShow">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
        优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="type[sup.type]" v-for="(sup,index) in info.supports" :key="index">
            <span class="content-tag" >
        ...
        <div class="activity-sheet-close" @click="isDiscountsShow=false">
          <span class="iconfont icon-close" ></span>
        </div>
      </div>
      <div class="activity-sheet-cover" @click="isDiscountsShow=false"></div>
    </div>
  </div>
</template>
...
import {mapState} from "vuex";
  export default {
    data(){
      return{
       isShopModal:false,
       isDiscountsShow:false,
       type:['activity-green','activity-red','activity-orange']
